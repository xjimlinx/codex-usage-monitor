...
- 自带 SVG 图标，与组件列表、设置页和任务栏保持一致
- 可在设置中动态调节任务栏紧凑视图的横向和纵向内边距
- 点击展开当前账号邮箱、登录方式、套餐、全部限额窗口、Credits、重置次数和重置时间
- 右键菜单支持重新连接当前 Codex 账号并立即更新用量
...
- 账号凭据失效时自动重新连接一次；手动刷新始终重新连接，不需要重启用户服务
